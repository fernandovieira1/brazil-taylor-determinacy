...
O regime de metas de inflação foi adotado no Brasil em 1999, após o abandono do regime de bandas cambiais, com o objetivo de restabelecer uma âncora nominal crível para a política monetária. A mudança seguiu a experiência internacional consolidada ao longo da década de 1990, na qual a estabilidade de preços passou a ser explicitamente definida como objetivo primário da política monetária. Nesse arcabouço, a autoridade monetária anuncia uma meta numérica para a inflação em horizonte relevante, utilizando a taxa de juros de curto prazo como principal instrumento para ancorar as expectativas dos agentes econômicos \cite{bernanke1997inflation,hammond2012state}.
...
\subsubsection{Presidentes do BACEN}

A condução da política monetária ao longo desse intervalo foi marcada por cinco administrações principais no Banco Central, cada uma operando sob desafios distintos impostos pela conjuntura governamental e econômica. A gestão de \textbf{Arminio Fraga} (1999–2002), durante o segundo governo de Fernando Henrique Cardoso, foi responsável pela implementação e consolidação inicial do regime de metas. Seguiu-se a longa administração de \textbf{Henrique Meirelles} (2003–2010), abrangendo os dois mandatos do governo Lula, período caracterizado pelo acúmulo de reservas internacionais e pelo enfrentamento da crise de 2008. \textbf{Alexandre Tombini} (2011–2016) presidiu a autarquia durante o governo Dilma Rousseff e o início da crise econômica doméstica. \textbf{Ilan Goldfajn} (2016–2019), nomeado pelo governo Temer, conduziu o processo de reancoragem das expectativas e o ciclo de cortes de juros pós-recessão. Por fim, \textbf{Roberto Campos Neto} (2019–2024), atuando sob os governos Bolsonaro e no início do terceiro mandato de Lula, enfrentou os choques inflacionários globais decorrentes da pandemia e liderou a transição para a autonomia formal da instituição.

Para a identificação dos episódios de ruptura, adotou-se um critério duplo: a cronologia oficial de recessões estabelecida pelo Comitê de Datação de Ciclos Econômicos \cite{codace2020} para a delimitação temporal, combinada à caracterização da natureza dos choques predominante na literatura especializada, conforme a caracterização predominante na literatura especializada, exemplificada por \citeonline{barbosa2017} para a crise doméstica recente. Sob essa métrica. Sob essa métrica, destacam-se quatro eventos estruturais: a \textbf{crise de confiança de 2002}, associada à incerteza eleitoral e à parada súbita de capitais; a \textbf{Crise Financeira Global de 2008}, que impôs um severo choque de liquidez externa; a \textbf{recessão doméstica de 2015–2016}, deflagrada por desajustes fiscais e realinhamento de preços; e a \textbf{pandemia de Covid-19 em 2020}, choque sanitário que exigiu estímulos monetários extraordinários.


\subsubsection{Comportamento dos Indicadores }
% PIB 
% Inflação (IPCA)
% Taxa Selic
% Hiato do Produto

São apresentados gráficos de séries temporais e estatísticas descritivas para o produto, a inflação (IPCA), a taxa Selic, o hiato do produto e as expectativas de inflação no período 1999--2024. As figuras destacam visualmente os períodos associados às diferentes presidências do Banco Central e os principais episódios de choque, permitindo uma análise descritiva dos padrões observados, como períodos de inflação acima ou abaixo da meta, fases de política monetária mais restritiva ou acomodatícia e episódios de hiatos do produto significativamente negativos ou positivos. Ressalta-se que essa análise tem caráter estritamente descritivo e não permite conclusões sobre determinância ou causalidade.

Incluir gráficos de série temporal e tabelas para o período 1999--2024, destacando, se for o caso, visualmente as mudanças de presidente do Banco Central (linhas verticais) e episódios relevantes / choques (crise de 2002, crise de 2008, recessão 2015--2016, pandemia de 2020 etc.).

Discutir, de forma não causal, padrões observados: períodos de inflação acima/abaixo da meta, fases de juros muito altos ou muito baixos, episódios de hiato fortemente negativo ou positivo.

Destacar que a análise descritiva não é suficiente para concluir sobre determinância, servindo apenas como \textit{benchmark} visual e histórico a ser formalmente testado pela metodologia econométrica nas seções seguintes.
