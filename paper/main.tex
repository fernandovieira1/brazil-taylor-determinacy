...
Os padrões documentados nesta seção sugerem que a condução da política monetária brasileira não foi invariável ao longo do regime de metas: a intensidade do aperto em episódios de desancoragem (2002--2003 e 2021--2022), a resposta contracíclica em choques de demanda (2008--2009 e 2020) e a dificuldade de estabilização em ambiente próximo à estagflação (2015--2016) indicam possível heterogeneidade da função de reação entre diferentes gestões do Banco Central. Essa heterogeneidade, contudo, não pode ser inferida visualmente, dado que inflação, expectativas, hiato e juros são determinados de forma conjunta e com defasagens. Assim, a Seção 5 formaliza uma estratégia de identificação baseada na estimação de diferentes especificações da Regra de Taylor (retrospectiva, prospectiva e híbrida), com instrumentos e erros robustos, e com segmentação por subperíodos e/ou quebras estruturais, permitindo testar diretamente se $\hat{\phi}_{\pi}>1$ e se os parâmetros estimados são compatíveis com a condição de Bullard--Mitra.
