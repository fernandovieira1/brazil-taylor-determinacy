...
Esta seção apresenta a estratégia empírica adotada para investigar a condução da política monetária brasileira no período de vigência do regime de metas de inflação. Conforme discutido na Seção~1, o objeto do trabalho é a reação sistemática do Banco Central do Brasil às flutuações da inflação e da atividade econômica, enquanto o problema central consiste em avaliar se essa reação foi compatível com a estabilidade macroeconômica no sentido do modelo NK. Os objetivos gerais e específicos delineados naquela seção orientam diretamente a abordagem empírica aqui desenvolvida, a qual busca verificar se os parâmetros que caracterizam a política monetária observada satisfazem o Princípio de Taylor e as condições de determinância associadas à unicidade do equilíbrio.
...
\begin{itemize}
    ...
    \item Explicar como a comparação dos coeficientes entre regimes permite avaliar a evolução da credibilidade e da aversão à inflação do BCB ao longo do tempo.
\end{itemize}
