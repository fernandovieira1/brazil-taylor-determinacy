...
EXPLICAR MELHOR 5.4.1, 5.4.2 E 5.4.3 EM RELAÇÃO A 5.4.4
...
Na especificação prospectiva, a autoridade monetária reage às expectativas de inflação e de hiato do produto, em consonância com a estrutura \textit{forward-looking} da NKPC e da equação IS discutidas nas Seções~\ref{subsec:nkpc} e~\ref{subsec:is_dinamica}. A modelagem empírica adotada inspira-se no arcabouço canônico proposto por \citeonline{clarida2000monetary}, amplamente utilizado na literatura como referência para a estimação de regras de política monetária prospectivas por meio do método dos momentos generalizados (GMM), como no estudo de \citeonline{jayawickrema2019monetary}. 

Nesse sentido, estima-se a seguinte regra de juros com suavização:
\begin{equation}
  i_t
  =
  \gamma_0
