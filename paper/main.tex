...
\label{subsubsec:taylor_hibrida}
\label{subsec:taylor_hibrida}
...
Isto dito, a comparação com a forma teórica com suavização (Seção~\ref{subsec:taylor_hibrida}) permite interpretar
\[
\rho = \beta_1,\qquad
