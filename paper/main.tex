...
O período analisado (1999-2024) é marcado em seus primeiros anos pela chamada ``Crise de Confiança'' de 2002--2003, associada à transição do governo Fernando Henrique Cardoso para o Governo de Luis Inácio Lula da Silva, que teve como consequência mais evidente a forte depreciação cambial observada no período em decorrência do ajuste de expectativas no mercado. Entre junho de 2002 e janeiro de 2003, a inflação acumulada em doze meses ultrapassou 15\% a.a., acompanhada de expressiva desancoragem das expectativas. A resposta da autoridade monetária foi um aperto monetário pronunciado, com a Selic atingindo patamares próximos a 25\% a.a. A subsequente reconvergência da inflação e das expectativas nos anos seguintes consolidou esse episódio como um marco inicial de credibilidade do regime, frequentemente interpretado na literatura como evidência empírica de uma resposta suficientemente agressiva da política monetária a desvios inflacionários.
...
Entre 2004 e 2010, observa-se um período de relativa estabilidade macroeconômica, caracterizado por crescimento sustentado do produto e inflação moderada, interrompido temporariamente pela Crise Financeira Global de 2008--2009. Embora o choque externo tenha provocado uma contração abrupta do nível de atividade, o impacto foi de curta duração, refletindo tanto estímulos fiscais quanto uma resposta monetária contracíclica. A rápida recuperação do PIB sugere que, nesse subperíodo, a economia operava próxima ao produto potencial, com hiatos relativamente reduzidos e expectativas bem ancoradas.

% Recessão Doméstica de 2015--2016
A partir de 2014, a economia brasileira entra em uma fase distinta, marcada pela recessão doméstica de 2015--2016. Esse episódio combina queda acentuada do produto com inflação persistentemente elevada, configurando um ambiente de estagflação. As estimativas do hiato do produto tornam-se fortemente negativas, enquanto a inflação permanece acima do centro — e, em diversos momentos, do teto — da meta. Esse contexto ilustra as limitações da política monetária quando choques fiscais, realinhamentos de preços administrados e deterioração das expectativas passam a dominar a dinâmica inflacionária. A resposta do Banco Central envolveu um ciclo de aperto monetário significativo, com a Selic atingindo níveis recordes, na tentativa de reancorar as expectativas e conter a inflação, embora o hiato do produto permanecesse negativo por um período prolongado.
...
O último grande choque da amostra corresponde à pandemia de Covid-19, iniciada em março de 2020. Trata-se da maior contração do nível de atividade observada na série, com um hiato do produto profundamente negativo. A resposta inicial da política monetária envolveu a redução da Selic ao menor nível histórico, refletindo a natureza extraordinária do choque. Contudo, a reabertura econômica e os choques globais de oferta subsequentes levaram a uma rápida reversão do cenário inflacionário em 2021--2022, exigindo um ciclo de aperto monetário robusto para reancorar as expectativas.
...
\begin{figure}[htbp]
    ...
    \footnotesize
    \vspace{0.2cm}
    \textbf{Fonte:} Bacen, via pacotes Python (python-bcb).\\
...
A Figura \ref{fig:hiato_produto} evidencia que, embora haja divergências quanto à magnitude dos desvios cíclicos entre as metodologias — com o Filtro de Hamilton apresentando maior volatilidade relativa —, os sinais e os pontos de inflexão do ciclo econômico são amplamente coincidentes. Em particular, os episódios recessivos de 2015--2016 e 2020 emergem de forma robusta em todas as especificações, sugerindo que, apesar da incerteza inerente à mensuração do produto potencial, o diagnóstico qualitativo sobre o estado cíclico da economia é relativamente estável.

Por fim, ressalta-se que a análise apresentada nesta subseção possui caráter estritamente descritivo. A co-movimentação observada entre inflação, expectativas, produto e taxa de juros é compatível com os mecanismos previstos pelo modelo novo-keynesiano, mas não permite inferências causais ou conclusões sobre determinância do equilíbrio. A presença de defasagens, simultaneidade e expectativas prospectivas exige uma abordagem econométrica formal, que será desenvolvida nas seções seguintes, nas quais se testará explicitamente se a resposta da política monetária ao longo dos diferentes subperíodos foi consistente com as condições teóricas de unicidade e estabilidade do equilíbrio.
