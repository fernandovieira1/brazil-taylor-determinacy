...
Antes de explicitar os objetivos do estudo, é importante delimitar o escopo e a natureza da contribuição pretendida. Este artigo não tem como objetivo propor extensões teóricas ao arcabouço Novo-Keynesiano nem desenvolver uma nova regra de política monetária. Em vez disso, busca aplicar de forma rigorosa e transparente o modelo ao caso brasileiro, conforme apresentado na literatura e discutido ao longo da disciplina, combinando fundamentação teórica, evidência empírica e análise de determinância do equilíbrio.
