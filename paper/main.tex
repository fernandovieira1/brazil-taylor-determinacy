...
\begin{itemize}
    \item Descrever brevemente a adoção do regime de metas de inflação em 1999: contexto da época, motivações e objetivos.
    \item Arquitetura institucional: meta de inflação, bandas, horizonte relevante, accountability, papel do Copom.
    \item Sistemática de funcionamento: uso da taxa Selic como instrumento, comunicação com o mercado, transparência.
