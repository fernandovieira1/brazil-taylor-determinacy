...
figure(1); 
clf;
subplot(3,2,1); plot(y_epsilon_v, '-o'); title('Output Gap');
subplot(3,2,2); plot(4*pi_epsilon_v, '-o'); title('Inflation');
subplot(3,2,3); plot(4*i_epsilon_v, '-o'); title('Nominal Rate');
subplot(3,2,4); plot(4*i_epsilon_v(1:end-1)-4*[pi_epsilon_v(2:end)], '-o'); title('Real Rate');
subplot(3,2,5); plot(4*(m_epsilon_v-[0;m_epsilon_v(1:end-1)]), '-o'); title('Money Growth');
...
//subplot(4,2,8); plot(a_epsilon_a, '-o'); title('a');
