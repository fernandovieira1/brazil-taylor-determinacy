...
figure(1); clf;
subplot(2,2,1); plot(tild_y_epsilon_v, '-o'); title('Output Gap');
subplot(2,2,2); plot(4*pi_p_epsilon_v, '-o'); title('Price Inflation');
subplot(2,2,3); plot(4*pi_w_epsilon_v, '-o'); title('Wage Inflation');
subplot(2,2,4); plot(w_epsilon_v, '-o'); title('Real Wage');


//figure(2); clf;
//subplot(3,2,1); plot(tild_y_epsilon_v, '-o'); title('Output Gap');
//subplot(3,2,2); plot(4*pi_p_epsilon_v, '-o'); title('Price Inflation');
//subplot(3,2,3); plot(4*pi_w_epsilon_v, '-o'); title('Wage Inflation');
//subplot(3,2,4); plot(w_epsilon_v, '-o'); title('Real wage gap');
//subplot(3,2,5); plot(n_epsilon_v, '-o'); title('Employment');
//subplot(3,2,6); plot(v_epsilon_v, '-o'); title('v');
