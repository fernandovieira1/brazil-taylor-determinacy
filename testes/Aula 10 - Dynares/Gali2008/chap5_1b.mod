...
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//
//Setting parameters - See chap3.mod and book's chap. 5 //    
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%//

parameters beta sigma phi alpha epsilon  eta theta  phi_y up_theta
lambda kappa rho rho_u rho_a  phi_pi alpha_x;
...
rho_u = 0.8;
rho_a = 0.9;
phi_pi=(1-rho_u)*((kappa*sigma)/(alpha_x))+rho_u;
