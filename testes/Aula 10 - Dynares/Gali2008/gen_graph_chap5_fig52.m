...
subplot(2,2,1); plot([0:12], y_SwSp, '-o', [0:12], y_FwSp, '-x'); title('Output Gap'); axis([0 12 -6.2 0.5]);
subplot(2,2,2); plot([0:12], pi_SwSp, '-o', [0:12], pi_FwSp, '-x'); title('Inflation'); axis([0 12 -0.12 1.0]);
subplot(2,2,3); plot([0:12], p_hat_SwSp, '-o', [0:12], p_hat_FwSp, '-x'); title('Price Level'); axis([0 12 -0.1 4.8]);
